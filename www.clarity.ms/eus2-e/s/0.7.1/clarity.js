/* clarity-js v0.7.1: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    var t = Object.freeze({
            __proto__: null,
            get start() {
                            ...
                            for (var u = 0; u < t.length; u++) {
                                ...
                                if (a = a || c >= 48 && c <= 57, r = r || 64 === c, i = 9 === c || 10 === c || 13 === c || 32 === c, 0 === u || u === t.length - 1 || i) {
                                    if (a || r) {
                                        ...
                                        s = p && null !== m ? s.match(m) ? s : s.replace(g, "▪").replace(v, "▫") : k(s), o.splice(e + 1 - n, s.length, s), n += s.length - 1
                                    }
                                    i && (a = !1, r = !1, e = u)
                                }
                            }
    ...
    function j(t, e) {
        $r() && t && e && "string" == typeof t && "string" == typeof e && t.length < 255 && e.length < 255 && (I = {
            key: t,
            value: e
        }, er(24))
    }
    ...
    function H(t, e) {
        null !== e && (t in L || (L[t] = 0), t in A || (A[t] = 0), L[t] += e, A[t] += e)
    }

    function Y(t, e) {
        null !== e && !1 === isNaN(e) && (t in L || (L[t] = 0), (e > L[t] || 0 === L[t]) && (A[t] = e, L[t] = e))
    }
    ...
    function V() {
        ...
        z = {
            gap: t - q
        }, er(25), z.gap < 3e5 ? U = W(V, P) : Zr && (j("clarity", "suspend"), vi(), ["mousemove", "touchstart"].forEach((function(t) {
    ...
    function rt(t, e, n) {
        void 0 === e && (e = null), void 0 === n && (n = null), it("userId", [t]), it("sessionId", [e]), it("pageId", [n])
    }

    function it(t, e) {
        if ($r() && t && e && "string" == typeof t && t.length < 255) {
            for (var n = (t in nt ? nt[t] : []), a = 0; a < e.length; a++) "string" == typeof e[a] && e[a].length < 255 && n.push(e[a]);
            nt[t] = n
        }
    }
    ...
    function dt(t) {
        return ct(this, void 0, void 0, (function() {
            ...
            return st(this, (function(a) {
                switch (a.label) {
                    case 0:
                        return a.trys.push([0, 3, , 4]), lt ? (e = new ReadableStream({
                            start: function(e) {
                                return ct(this, void 0, void 0, (function() {
                        ...
                        }).pipeThrough(new TextEncoderStream).pipeThrough(new window.CompressionStream("gzip")), n = Uint8Array.bind, [4, ft(e)]) : [3, 2];
                    case 1:
    ...
    function yt(t, e, n) {
        u.fraud && null !== t && n && n.length >= 5 && (mt = {
            id: t,
            target: e,
            checksum: f(n, 24)
            ...
            default:
                ...
                if (u && u.length > 0)
                    if (0 === e) {
                        ...
                        c in kt || (kt[c] = []), kt[c].indexOf(t.id) < 0 && kt[c].push(t.id), i = "".concat(c).concat("~").concat(kt[c].indexOf(t.id))
                    } else i = "".concat(a).concat(t.tag, ".").concat(u).concat(r);
                return i = o && Ot(o) ? "".concat(function(t) {
    ...
    function Dt(t, e) {
        return void 0 === e && (e = 0), ct(this, void 0, void 0, (function() {
            var n, a, r;
    ...
    function Ct() {
        ...
        t && (St = t, t.task().then((function() {
            ...
            t.id === wr() && (e && Ya(0, 1, e.name, e.message, e.stack), St = null, Ct())
        })))
    }
    ...
    var Ht, Yt = window.requestIdleCallback || function(t, e) {
    ...
    function Wt(t, e, n) {
        return void 0 === e && (e = null), void 0 === n && (n = null), ct(this, void 0, void 0, (function() {
            ...
            return st(this, (function(D) {
                switch (D.label) {
                    case 0:
                        ...
                        return [3, 10];
                    case 1:
                        return i = Ht, r.push(i.width), r.push(i.height), N(t, i.width, i.height), Na(r), [3, 10];
                    case 2:
                        for (o = 0, c = Kn; o < c.length; o++) s = c[o], (r = [s.time, 7]).push(s.data.id), r.push(s.data.interaction), r.push(s.data.visibility), r.push(s.data.name), Na(r);
                        return sa(), [3, 10];
                    case 3:
                        ...
                        f = 0, h = d, D.label = 4;
                    case 4:
                        return f < h.length ? (p = h[f], 0 !== (v = It(e)) ? [3, 6] : [4, Lt(e)]) : [3, 8];
                    case 5:
                        v = D.sent(), D.label = 6;
                    case 6:
                        if (2 === v) return [3, 8];
                        for (g = p.data, m = p.metadata.active, y = p.metadata.suspend, w = p.metadata.privacy, k = function(t) {
                            ...
                            }(p), E = 0, O = m ? ["tag", "attributes", "value"] : ["tag"]; E < O.length; E++)
                            if (g[x = O[E]]) switch (x) {
                                case "tag":
                                    M = Xt(p), S = k ? -1 : 1, r.push(p.id * S), p.parent && m && r.push(p.parent), p.previous && m && r.push(p.previous), r.push(y ? "*M" : g[x]), M && 2 === M.length && r.push("".concat("#").concat(qt(M[0]), ".").concat(qt(M[1])));
                                    break;
                                case "attributes":
                                    for (T in g[x]) void 0 !== g[x][T] && r.push(Pt(T, g[x][T], w));
                                    break;
                                case "value":
                                    yt(p.metadata.fraud, p.id, g[x]), r.push(b(g[x], g.tag, w, k))
                            }
                        D.label = 7;
                    case 7:
                        return f++, [3, 4];
                    case 8:
                        6 === t && _(a), Na(function(t) {
    ...
    function Bt() {
        ...
        null !== Ht && c === Ht.width && v === Ht.height || null === c || null === v || (Ht = {
            width: c,
            height: v
        }, Wt(8))
    }
    ...
    function se(t) {
        ...
        if (e && e.type && n) {
            ...
            ce.length > 0 && ce[ce.length - 1].data.target === r.target && ce.pop(), ce.push({
                time: l(t),
                event: 27,
                data: r
            }), X(ue), ue = W(le, 1e3, 27)
    ...
    function ge(t, e, n) {
        ...
        if (i)
            for (var u = 0; u < i.length; u++) {
                ...
                s = s && a ? s + Math.round(a.offsetLeft) : s, d = d && a ? d + Math.round(a.offsetTop) : d, null !== s && null !== d && me({
                    time: o,
                    event: t,
                    data: {
                        target: la(n),
    ...
    function me(t) {
        switch (t.event) {
            ...
            case 19:
                ...
                }(n, t) && he.pop(), he.push(t), X(pe), pe = W(be, 500, t.event);
                break;
            default:
    ...
    function xe(t) {
        ...
        if ((null !== t || 0 !== i || 0 !== o) && null !== i && null !== o) {
            ...
            }(s, u) && Ee.pop(), Ee.push(u), X(Oe), Oe = W(Me, 500, 10)
        }
    }
    ...
    function Te(t) {
        ...
        if (null !== e && !(null === e.anchorNode && null === e.focusNode || e.anchorNode === e.focusNode && e.anchorOffset === e.focusOffset)) {
            ...
            null !== Ne && null !== Se.start && n !== e.anchorNode && (X(_e), De(21)), Se = {
                start: e.anchorNode,
                startOffset: e.anchorOffset,
                end: e.focusNode,
                endOffset: e.focusOffset
            }, Ne = e, X(_e), _e = W(De, 500, 21)
        }
    }
    ...
    function Xe(t) {
        ...
        }(t), t.nodeType === Node.DOCUMENT_NODE && (Qt(t), function(t) {
            Wr(t, "cut", ie.bind(this, 0), !0), Wr(t, "copy", ie.bind(this, 1), !0), Wr(t, "paste", ie.bind(this, 2), !0)
        }(t), function(t) {
            Wr(t, "mousedown", ve.bind(this, 13, t), !0), Wr(t, "mouseup", ve.bind(this, 14, t), !0), Wr(t, "mousemove", ve.bind(this, 12, t), !0), Wr(t, "wheel", ve.bind(this, 15, t), !0), Wr(t, "dblclick", ve.bind(this, 16, t), !0), Wr(t, "touchstart", ge.bind(this, 17, t), !0), Wr(t, "touchend", ge.bind(this, 18, t), !0), Wr(t, "touchmove", ge.bind(this, 19, t), !0), Wr(t, "touchcancel", ge.bind(this, 20, t), !0)
        }(t), function(t) {
            Wr(t, "input", se, !0)
        }(t), function(t) {
            Wr(t, "selectstart", Te.bind(this, t), !0), Wr(t, "selectionchange", Te.bind(this, t), !0)
        }(t), function(t) {
            Wr(t, "change", Ft, !0)
        }(t), function(t) {
            Wr(t, "submit", Le, !0)
    ...
    var qe = Object.freeze({
            __proto__: null,
            start: function() {
                ha = [], va(), ae(), oe(), ye(), de(), Wr(window, "resize", we), we(), Wr(document, "visibilitychange", Ye), Ye(), Ee = [], xe(), Ce(), Jt(), Ae(), Wr(window, "pagehide", Re)
            },
            stop: function() {
                ha = [], va(), ae(), oe(), X(pe), he.length > 0 && be(he[he.length - 1].event), X(ue), de(), ke(), We(), X(Oe), Ee = [], Ce(), X(_e), Jt(), Ae(), He()
            },
            observe: Xe
        }),
        Pe = /[^0-9\.]/g;
        ...
        for (var e = 0, n = Object.keys(t); e < n.length; e++) {
            ...
            if ("@type" === a && "string" == typeof r) switch (r = (r = r.toLowerCase()).indexOf("article") >= 0 || r.indexOf("posting") >= 0 ? "article" : r) {
                ...
                case "recipe":
                    ...
                    break;
                case "product":
                    dr(5, t[a]), dr(10, t.name), dr(12, t.sku), t.brand && dr(6, t.brand.name);
                    break;
                case "aggregaterating":
                    t.ratingValue && (Y(11, Be(t.ratingValue, 100)), Y(18, Be(t.bestRating)), Y(19, Be(t.worstRating))), Y(12, Be(t.ratingCount)), Y(17, Be(t.reviewCount));
                    break;
                case "person":
                    dr(8, t.name);
                    break;
                case "offer":
                    dr(7, t.availability), dr(14, t.itemCondition), dr(13, t.priceCurrency), dr(12, t.sku), Y(13, Be(t.price));
                    break;
                case "brand":
                    dr(6, t.name)
            }
    ...
    var Ve = ["title", "alt", "onload", "onfocus", "onerror", "data-drupal-form-submit-last"],
        Fe = /[\r\n]+/g;
    ...
    function Je(e, n) {
        ...
        switch (e.nodeType) {
            ...
            case Node.DOCUMENT_FRAGMENT_NODE:
                var l = e;
                if (l.host)
                    if (zn(l), "function" === typeof l.constructor && l.constructor.toString().indexOf("[native code]") >= 0) {
                        Ge(l);
                ...
                break;
            case Node.TEXT_NODE:
                if (o = o || e.parentNode, "update" === i || o && Fn(o) && "STYLE" !== o.tagName) {
                    var v = {
                        tag: "*T",
                        value: e.nodeValue
                    };
            ...
            case Node.ELEMENT_NODE:
                ...
                switch (o = e.parentElement ? e.parentElement : e.parentNode ? e.parentNode : null, "http://www.w3.org/2000/svg" === g.namespaceURI && (m = "svg:" + m), m) {
                    ...
                    case "IFRAME":
                        ...
                        Hn(N) && (! function(t) {
                            !1 === Fn(t) && Wr(t, "load", pn.bind(this, t, "childList"), !0)
        ...
        return ct(this, void 0, void 0, (function() {
            ...
            return st(this, (function(s) {
                switch (s.label) {
                    ...
                    case 2:
                        return n < a.length ? (r = a[n], 0 !== (i = It(t)) ? [3, 4] : [4, Lt(t)]) : [3, 6];
                    case 3:
                        i = s.sent(), s.label = 4;
                    case 4:
                        if (2 === i) return [3, 6];
                        switch (o = r.target, u = function(t, e) {
                            ...
                            if (n && "HTML" !== n.data.tag) {
                                var a = l() > un,
                                    ...
                                    o = [n.selector ? n.selector.join() : "", i, t.attributeName, dn(t.addedNodes), dn(t.removedNodes)].join();
                                cn[o] = o in cn ? cn[o] : [0];
                                var u = cn[o];
                                if (!1 === a && u[0] >= 10 && fn(u[1], 2, e), u[0] = a ? u[0] + 1 : 1, 10 === u[0]) return u[1] = t.removedNodes, "suspend";
                                if (u[0] > 10) return ""
                            }
                            return t.type
                        }(r, t), u && o && o.ownerDocument && zn(o.ownerDocument), u && o && o.nodeType == Node.DOCUMENT_FRAGMENT_NODE && o.host && zn(o), u) {
                            case "attributes":
                                Je(o, 3);
                                break;
                            case "characterData":
        ...
        return ct(this, void 0, void 0, (function() {
            ...
            return st(this, (function(o) {
                switch (o.label) {
                    ...
                    case 1:
                        return r < a ? 1 !== e ? [3, 2] : (Qe(t[r], n, e), [3, 5]) : [3, 6];
                    case 2:
    ...
    function hn(t, e) {
        return void 0 === e && (e = !1), rn.indexOf(t) < 0 && rn.push(t), on && X(on), on = W((function() {
            ! function(t) {
    ...
    function jn() {
        vn = 1, gn = [], mn = [], bn = [], yn = {}, wn = [], kn = [], On = "address,password,contact".split(","), xn = "password,secret,pass,social,ssn,code,hidden".split(","), Mn = "radio,checkbox,range,button,reset,submit".split(","), Sn = "INPUT,SELECT,TEXTAREA".split(","), Nn = new WeakMap, _n = new WeakMap, Tn = new WeakMap, Dn = new WeakMap, kt = {}
    }
    ...
    function An(t, e, n, a) {
        var r, i = Ln(t, !0),
            ...
            h = u.content ? 1 : 3;
        o >= 0 && mn[o] && ((s = mn[o]).children.push(i), l = null === l ? s.region : l, d = s.fragment, f = null === f ? s.metadata.fraud : f, h = s.metadata.privacy), n.attributes && "data-clarity-region" in n.attributes && (aa(t, n.attributes["data-clarity-region"]), l = i), gn[i] = t, mn[i] = {
                id: i,
                parent: o,
                previous: c,
                children: [],
            ...
            function(t, e, n) {
                ...
                switch (!0) {
                    ...
                    case "*T" === u:
                        ...
                        r.privacy = h.includes(d) || wn.some((function(t) {
            ...
            }(t, mn[i], s), Xn(mn[i]), "IMG" === (r = mn[i]).data.tag && 3 === r.metadata.privacy && (r.metadata.size = []), Zn(i, a, mn[i].fragment)
    }
    ...
    function Rn(t, e, n, a) {
        ...
        if (r in mn) {
            ...
            s.fragment && En[s.fragment] && (u = !0), Xn(s), Zn(r, a, mn[r].fragment, u, c)
        }
    }
    ...
    function Xn(t) {
        ...
        t.selector = [Et(i, 0), Et(i, 1)], t.hash = t.selector.map((function(t) {
            return t ? f(t) : null
    ...
    function Gn(t) {
        for (var e = null; null === e && t.previousSibling;) e = Ln(t.previousSibling), t = t.previousSibling;
        return e
    }

    function Zn(t, e, n, a, r) {
        if (void 0 === n && (n = null), void 0 === a && (a = !0), void 0 === r && (r = !1), n && !En[n]) {
            var i = Pn(n),
                o = Un(n);
            i && o && (hn(i, !0), o.hash.forEach((function(t) {
                -1 !== Ba.indexOf(t) && (En[n] = t)
            })))
        }
        var u = bn.indexOf(t);
        u >= 0 && 1 === e && r ? (bn.splice(u, 1), bn.push(t)) : -1 === u && a && bn.push(t)
    }
    var Kn = [],
        Qn = null,
        $n = {},
    ...
    function aa(t, e) {
        !1 === Qn.has(t) && (Qn.set(t, e), (na = null === na && ea ? new IntersectionObserver(oa, {
            threshold: [0, .2, .4, .6, .8, 1]
        }) : na) && t && t.nodeType === Node.ELEMENT_NODE && na.observe(t))
    }
    ...
    function ia() {
        for (var t = [], e = 0, n = ta; e < n.length; e++) {
            var a = n[e],
                r = Ln(a.node);
            r in $n || (r ? (a.data.id = r, $n[r] = a.data, Kn.push(ca(a.data))) : t.push(a))
        }
    ...
    function oa(t) {
        for (var e = 0, n = t; e < n.length; e++) {
            ...
            if (Qn.has(r) && i.width + i.height > 0 && u.width > 0 && u.height > 0) {
                ...
                ua(r, s, s.interaction, d ? 13 : l ? 10 : 0), s.visibility >= 13 && na && na.unobserve(r)
            }
        }
        Kn.length > 0 && Wt(7)
    }
    ...
    function ua(t, e, n, a) {
        ...
        e.interaction = n > e.interaction ? n : e.interaction, e.visibility = a > e.visibility ? a : e.visibility, e.id ? (e.id in $n && r || !(e.id in $n)) && ($n[e.id] = e, Kn.push(ca(e))) : ta.push({
            node: t,
            data: e
        })
    }
    ...
    function la(t) {
        ...
        return un = l() + 3e3, n.nodeType === Node.DOCUMENT_NODE ? n.documentElement : n
    }
    ...
    function da(t, e, n) {
        ...
        if (t) {
            ...
            if (null !== r) {
                ...
                }(r.region, e), i.fraud && yt(i.fraud, r.id, n || r.data.value)
            }
        }
        return a
    }
    ...
    function fa(t, e) {
        return void 0 === e && (e = null), ct(this, void 0, void 0, (function() {
            var n, a, r, i, o, u, c, s, d, f, h, p, v, g, m, w, k, E, O, x, M, S, _, D, C, I, j, z, L, A, R;
            return st(this, (function(H) {
                switch (n = e || l(), a = [n, t], t) {
                    ...
                    case 19:
                    case 20:
                        for (r = 0, i = he; r < i.length; r++) A = i[r], (o = da(A.data.target, A.event)).id > 0 && ((a = [A.time, A.event]).push(o.id), a.push(A.data.x), a.push(A.data.y), Na(a), N(A.event, A.data.x, A.data.y));
                        ye();
                        break;
                    case 9:
                        for (u = 0, c = Kt; u < c.length; u++) A = c[u], s = da(A.data.target, A.event, A.data.text), a = [A.time, A.event], d = s.hash.join("."), a.push(s.id), a.push(A.data.x), a.push(A.data.y), a.push(A.data.eX), a.push(A.data.eY), a.push(A.data.button), a.push(A.data.reaction), a.push(A.data.context), a.push(b(A.data.text, "click", s.privacy)), a.push(y(A.data.link)), a.push(d), a.push(A.data.trust), Na(a), ga(A.time, A.event, d, A.data.x, A.data.y, A.data.reaction, A.data.context);
                        ae();
                        break;
                    case 38:
                        for (f = 0, h = re; f < h.length; f++) A = h[f], a = [A.time, A.event], (j = da(A.data.target, A.event)).id > 0 && (a.push(j.id), a.push(A.data.action), Na(a));
                        oe();
                        break;
                    case 11:
                        p = fe, a.push(p.width), a.push(p.height), N(t, p.width, p.height), ke(), Na(a);
                        break;
                    case 26:
                        v = Ie, a.push(v.name), He(), Na(a);
                        break;
                    case 27:
                        for (g = 0, m = ce; g < m.length; g++) A = m[g], w = da(A.data.target, A.event, A.data.value), (a = [A.time, A.event]).push(w.id), a.push(b(A.data.value, "input", w.privacy)), Na(a);
                        de();
                        break;
                    case 21:
                        (k = Se) && (E = da(k.start, t), O = da(k.end, t), a.push(E.id), a.push(k.startOffset), a.push(O.id), a.push(k.endOffset), Ce(), Na(a));
                        break;
                    case 10:
                        for (x = 0, M = Ee; x < M.length; x++) A = M[x], (S = da(A.data.target, A.event)).id > 0 && ((a = [A.time, A.event]).push(S.id), a.push(A.data.x), a.push(A.data.y), Na(a), N(A.event, A.data.x, A.data.y));
                        Ee = [];
                        break;
                    case 42:
                        for (_ = 0, D = Vt; _ < D.length; _++) A = D[_], a = [A.time, A.event], (j = da(A.data.target, A.event)).id > 0 && ((a = [A.time, A.event]).push(j.id), a.push(A.data.type), a.push(b(A.data.value, "change", j.privacy)), a.push(b(A.data.checksum, "checksum", j.privacy)), Na(a));
                        Jt();
                        break;
                    case 39:
                        for (C = 0, I = ze; C < I.length; C++) A = I[C], a = [A.time, A.event], (j = da(A.data.target, A.event)).id > 0 && (a.push(j.id), Na(a));
                        Ae();
                        break;
                    case 22:
                        for (z = 0, L = pa; z < L.length; z++) A = L[z], (a = [A.time, A.event]).push(A.data.type), a.push(A.data.hash), a.push(A.data.x), a.push(A.data.y), a.push(A.data.reaction), a.push(A.data.context), Na(a, !1);
                        va();
                        break;
                    case 28:
    ...
    var ma, ba, ya, wa, ka, Ea = 0,
        Oa = 0,
        xa = null,
        Ma = 0;

    function Sa() {
        wa = !0, Ea = 0, Oa = 0, Ma = 0, ma = [], ba = [], ya = {}, ka = null
    }
    ...
    function Na(t, e) {
        if (void 0 === e && (e = !0), wa) {
            ...
            n - Ma > 2 * i && (X(xa), xa = null), e && null === xa && (25 !== a && B(), xa = W(Ta, i), Ma = n, ar(Oa))
        }
    }

    function _a() {
        X(xa), Ta(!0), Ea = 0, Oa = 0, Ma = 0, ma = [], ba = [], ya = {}, ka = null, wa = !1
    }

    function Ta(t) {
        return void 0 === t && (t = !1), ct(this, void 0, void 0, (function() {
            var e, n, a, r, i, o, c, s;
            return st(this, (function(l) {
                switch (l.label) {
                    case 0:
                        return xa = null, (e = !1 === u.lean && Oa > 0 && (Oa < 1048576 || Ir.sequence > 0)) && Y(1, 1), ia(),
                            function() {
                                var t = [];
                                pa = [];
                                for (var e = Ir.start + Ir.duration, n = Math.max(e - 2e3, 0), a = 0, r = ha; a < r.length; a++) {
                                    var i = r[a];
                                    i.time >= n && (i.time <= e && pa.push(i), t.push(i))
                                }
                                ha = t, fa(22)
                            }(), gt(), n = !0 === t, a = JSON.stringify(Lr(n)), r = "[".concat(ba.join(), "]"), i = e ? "[".concat(ma.join(), "]") : "", o = function(t) {
                    ...
                    case 2:
                        s = l.sent(), l.label = 3;
                    case 3:
                        return H(2, (c = s) ? c.length : o.length), Da(o, c, Ir.sequence, n), ba = [], e && (ma = [], Oa = 0, Ea = 0), [2]
                }
            }))
        }))
    }
    ...
    function Ca(t, e) {
        var n = ya[e];
        t && 4 === t.readyState && n && ((t.status < 200 || t.status > 208) && n.attempts <= 1 ? t.status >= 400 && t.status < 500 ? rr(6) : (0 === t.status && (u.upload = u.fallback ? u.fallback : u.upload), Da(n.data, null, e)) : (ka = {
            sequence: e,
            attempts: n.attempts,
            status: t.status
        }, n.attempts > 1 && er(2), 200 === t.status && t.responseText && function(t) {
        ...
        }(t.responseText), 0 === t.status && (Da(n.data, null, e, !0), rr(3)), t.status >= 200 && t.status <= 208 && Ia(e), delete ya[e]))
    }
    ...
    function La(t) {
        var e = t.error || t;
        return e.message in za || (za[e.message] = 0), za[e.message]++ >= 5 || e && e.message && (ja = {
            message: e.message,
            line: t.lineno,
            column: t.colno,
            stack: e.stack,
    ...
    function Aa(t) {
        return ct(this, void 0, void 0, (function() {
            ...
            return st(this, (function(n) {
                switch (e = [l(), t], t) {
                    case 31:
                        e.push(ja.message), e.push(ja.line), e.push(ja.column), e.push(ja.stack), e.push(y(ja.source)), Na(e);
                        break;
                    case 33:
                        Ra && (e.push(Ra.code), e.push(Ra.name), e.push(Ra.message), e.push(Ra.stack), e.push(Ra.severity), Na(e, !1));
                        break;
                    case 41:
                        mt && (e.push(mt.id), e.push(mt.target), e.push(mt.checksum), Na(e, !1))
                }
                return [2]
            }))
        }))
    ...
    function Ya(t, e, n, a, r) {
        ...
        t in Ha && Ha[t].indexOf(i) >= 0 || (Ra = {
            code: t,
            name: n,
            message: a,
            stack: r,
            severity: e
        }, t in Ha ? Ha[t].push(i) : Ha[t] = [i], Aa(33))
    }
    var Wa, Xa = {},
        qa = [],
        Pa = {},
    ...
    function Za(t, e, n) {
        void 0 === n && (n = !1), (!(t in Xa) || t in Xa && Xa[t] !== e || n) && (Xa[t] = e, qa.push(t))
    }
    ...
    function er(t) {
        ...
        switch (t) {
            case 4:
                var n = O;
                n && ((e = [n.time, n.event]).push(n.data.visible), e.push(n.data.docWidth), e.push(n.data.docHeight), e.push(n.data.screenWidth), e.push(n.data.screenHeight), e.push(n.data.scrollX), e.push(n.data.scrollY), e.push(n.data.pointerX), e.push(n.data.pointerY), e.push(n.data.activityTime), Na(e, !1)), S();
                break;
            case 25:
                e.push(z.gap), Na(e);
                break;
    ...
    function ar(t) {
        if (0 === Wa.check) {
            var e = Wa.check;
            e = Ir.sequence >= 128 ? 1 : e, e = l() > 72e5 ? 2 : e, (e = t > 10485760 ? 2 : e) !== Wa.check && rr(e)
        }
    }
    ...
    function dr(t, e) {
        e && (e = "".concat(e), t in ur || (ur[t] = []), ur[t].indexOf(e) < 0 && (ur[t].push(e), t in cr || (cr[t] = []), cr[t].push(e), ur[t].length > 128 && rr(5)))
    }
    ...
    function mr() {
        ...
        var t, e = navigator && "userAgent" in navigator ? navigator.userAgent : "",
            ...
            a = function() {
                ...
                if (e) {
                    var n = e.split("|");
                    n.length >= 5 && t.ts - Nr(n[1]) < 18e5 && (t.session = n[0], t.count = Nr(n[2]) + 1, t.upgrade = Nr(n[3]), t.upload = n.length >= 6 ? "".concat("https://").concat(n[5], "/").concat(n[4]) : "".concat("https://").concat(n[4]))
                }
                return t
            }(),
            r = _r(),
        ...
        pr = {
            ...
            sessionId: a.session,
            pageNum: a.count
        }, u.lean = u.track && null !== a.upgrade ? 0 === a.upgrade : u.lean, u.upload = u.track && "string" == typeof u.upload && a.upload && a.upload.length > "https://".length ? a.upload : u.upload, dr(0, e), dr(3, n), dr(1, y(location.href)), dr(2, document.referrer), dr(15, function() {
            var t = Sr();
            ...
            return t
        }()), dr(16, document.documentElement.lang), dr(17, document.dir), dr(26, "".concat(window.devicePixelRatio)), Y(0, a.ts), Y(1, 0), navigator && (dr(9, navigator.language), Y(33, navigator.hardwareConcurrency), Y(32, navigator.maxTouchPoints), Y(34, Math.round(navigator.deviceMemory)), (t = navigator.userAgentData) && t.getHighEntropyValues ? t.getHighEntropyValues(["model", "platform", "platformVersion", "uaFullVersion"]).then((function(t) {
            var e;
            dr(22, t.platform), dr(23, t.platformVersion), null === (e = t.brands) || void 0 === e || e.forEach((function(t) {
                dr(24, t.name + "~" + t.version)
            })), dr(25, t.model), Y(27, t.mobile ? 1 : 0)
        })) : dr(22, navigator.platform)), screen && (Y(14, Math.round(screen.width)), Y(15, Math.round(screen.height)), Y(16, Math.round(screen.colorDepth)));
    ...
    function yr(t, e) {
        void 0 === e && (e = !0), pr && !1 === e && t(pr, !u.lean), vr.push({
            callback: t,
            wait: e
        })
    }
    ...
    function Or() {
        var t = Math.round(Date.now()),
            ...
            n = u.lean ? 0 : 1;
        ! function(t) {
            vr.length > 0 && vr.forEach((function(e) {
                !e.callback || e.wait && !t || e.callback(pr, !u.lean)
            }))
        }(n), Dr("_clsk", [pr.sessionId, t, pr.pageNum, n, e].join("|"), 1)
    }
    ...
    function Mr(t, e) {
        ...
        (null === t.expiry || Math.abs(n - t.expiry) >= 1 || t.consent !== e) && Dr("_clck", [pr.userId, 1, n.toString(36), e].join("|"), 365)
    }
    ...
    function _r() {
        ...
        if (e && e.length > 0) {
            ...
            n.length > 2 && (t.expiry = Nr(n[2], 36)), n.length > 3 && 1 === Nr(n[3]) && (t.consent = 1), u.track = u.track || 1 === t.consent, t.id = u.track ? n[0] : t.id
        }
        return t
    }
    ...
    function Dr(t, e, n) {
        if (u.track && (navigator && navigator.cookieEnabled || xr(document, "cookie"))) {
            var a = new Date;
            ...
            try {
                if (null === gr) {
                    for (var o = location.hostname ? location.hostname.split(".") : [], c = o.length - 1; c >= 0; c--)
                        if (gr = ".".concat(o[c]).concat(gr || ""), c < o.length - 1 && (document.cookie = "".concat(i).concat(";").concat("domain=").concat(gr), Tr(t) === e)) return;
                    gr = ""
                }
            } catch (t) {
                gr = ""
            }
            document.cookie = gr ? "".concat(i).concat(";").concat("domain=").concat(gr) : i
        }
    }
    var Cr, Ir = null;
    ...
    function Lr(t) {
        return Ir.start = Ir.start + Ir.duration, Ir.duration = l() - Ir.start, Ir.sequence++, Ir.upload = t && "sendBeacon" in navigator ? 1 : 0, Ir.end = t ? 1 : 0, [Ir.version, Ir.sequence, Ir.start, Ir.duration, Ir.projectId, Ir.userId, Ir.sessionId, Ir.pageNum, Ir.upload, Ir.end]
    }
    ...
    function Wr(t, e, n, a) {
        void 0 === a && (a = !1), n = Hr(n);
        try {
            t[c("addEventListener")](e, n, a), Yr.push({
                event: e,
                target: t,
                listener: n,
                capture: a
    ...
    function Kr() {
        Zr = !0, s = performance.now(), Tt(), Xr(), Ar(), Ur = Gr(), Br = 0, Wr(window, "popstate", Fr), null === qr && (qr = history.pushState, history.pushState = function() {
            qr.apply(this, arguments), $r() && Vr() && Fr()
        }), null === Pr && (Pr = history.replaceState, history.replaceState = function() {
    ...
    var ri = Object.freeze({
        __proto__: null,
        start: function() {
            Ut(), Bt(), sa(), na = null, Qn = new WeakMap, $n = {}, ta = [], ea = !!window.IntersectionObserver, Cn(),
                function() {
                    if ($e = [], rn = [], on = null, un = 0, cn = {}, null === en && (en = CSSStyleSheet.prototype.insertRule, CSSStyleSheet.prototype.insertRule = function() {
                            return $r() && hn(this.ownerNode), en.apply(this, arguments)
                        }), null === nn && (nn = CSSStyleSheet.prototype.deleteRule, CSSStyleSheet.prototype.deleteRule = function() {
                            return $r() && hn(this.ownerNode), nn.apply(this, arguments)
                        }), null === an) {
                        an = Element.prototype.attachShadow;
                        try {
                            Element.prototype.attachShadow = function() {
                                return $r() ? hn(an.apply(this, arguments)) : an.apply(this, arguments)
                            }
                        } catch (t) {
                            an = null
                        }
        ...
        stop: function() {
            sa(), Qn = null, $n = {}, ta = [], na && (na.disconnect(), na = null), ea = !1, In(),
                function() {
        ...
        oi = {
            ...
            function(t) {
                ct(this, void 0, void 0, (function() {
                    var e, n;
                    return st(this, (function(a) {
                        return e = l(), n = [e, t], 29 === t && (n.push(oi.fetchStart), n.push(oi.connectStart), n.push(oi.connectEnd), n.push(oi.requestStart), n.push(oi.responseStart), n.push(oi.responseEnd), n.push(oi.domInteractive), n.push(oi.domComplete), n.push(oi.loadEventStart), n.push(oi.loadEventEnd), n.push(oi.redirectCount), n.push(oi.size), n.push(oi.type), n.push(oi.protocol), n.push(oi.encodedSize), n.push(oi.decodedSize), ui(), Na(n, !1)), [2]
                    }))
                }))
            }(29)
    }
    var si = ["navigation", "resource", "longtask", "first-input", "layout-shift", "largest-contentful-paint"];
    ...
    function li() {
        try {
            ...
            for (var t = 0, e = si; t < e.length; t++) {
                var n = e[t];
                PerformanceObserver.supportedEntryTypes.indexOf(n) >= 0 && ("layout-shift" === n && H(9, 0), ii.observe({
                    type: n,
                    buffered: !0
                }))
            }
        ...
        ! function(t) {
            for (var e = (!("visibilityState" in document) || "visible" === document.visibilityState), n = 0; n < t.length; n++) {
                ...
                switch (a.entryType) {
                    ...
                    case "resource":
                        var r = a.name;
                        dr(4, fi(r)), r !== u.upload && r !== u.fallback || Y(28, a.duration);
                        break;
                    case "longtask":
                        R(7);
                        break;
            ...
            performance && "memory" in performance && performance.memory.usedJSHeapSize && Y(30, Math.abs(performance.memory.usedJSHeapSize / 1048576))
        }(t.getEntries())
    }
    ...
    var hi = [ni, ri, qe, Object.freeze({
        __proto__: null,
        start: function() {
            ui(),
                function() {
                    navigator && "connection" in navigator && dr(27, navigator.connection.effectiveType), window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? Wr(window, "load", W.bind(this, li, 0)) : li() : Ya(3, 0)
                }()
        },
        stop: function() {
    ...
    function pi(t) {
        void 0 === t && (t = null),
            function() {
                try {
                    return !1 === Zr && "undefined" != typeof Promise && window.MutationObserver && document.createTreeWalker && "now" in Date && "now" in performance && "undefined" != typeof WeakMap
                } catch (t) {
                    return !1
                }
            }() && (ti(t), Kr(), pt(), hi.forEach((function(t) {
                return Hr(t.start)()
            })))
    }

    function vi() {
        $r() && (hi.slice().reverse().forEach((function(t) {
            return Hr(t.stop)()
        })), vt(), Qr())
    }
    var gi = Object.freeze({
        ...
        start: pi,
        pause: function() {
            $r() && (j("clarity", "pause"), null === Nt && (Nt = new Promise((function(t) {
                _t = t
            }))))
        },
        resume: function() {
            $r() && (Nt && (_t(), Nt = null, null === St && Ct()), j("clarity", "resume"))
        },
        stop: vi,
        consent: kr,
        event: j,
